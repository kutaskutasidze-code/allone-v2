...
export function DraftPanel({ draft, jobId, status }: DraftPanelProps) {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-[var(--allone-line)] bg-[var(--bg-surface)] lg:col-span-2">
      ...
      {!draft ? (
        <div className="flex items-center justify-center px-5 py-12 text-sm text-[var(--ink-500)]">
        ...
        <>
          <div className="border-b border-[var(--allone-line)] px-5 py-3">
            {view === "edit" ? (
              ...
              <p className="text-sm font-medium text-[var(--ink-900)]">{subject}</p>
            )}
          </div>
          ...
          {!sent && (
            <div className="flex items-center justify-between gap-2 border-t border-[var(--allone-line)] px-5 py-3">
