          ...
          >
            <div className="grid grid-cols-2 gap-3 mb-3">
              <div>
                ...
                <input
                  type="text"
                  name="name"
                  placeholder={t('services.consult.name')}
                  className="w-full h-9 px-3 rounded-lg bg-white/50 backdrop-blur-md border border-gray-200/60 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#0A68F5]/40 focus:ring-1 focus:ring-[#0A68F5]/20 transition-all"
                />
              </div>
              <div>
            ...
            <div className="mb-4">
              ...
              <textarea
                name="message"
                rows={2}
                className="w-full px-3 py-2 rounded-lg bg-white/50 backdrop-blur-md border border-gray-200/60 text-sm text-gray-900 placeholder-gray-400 resize-none focus:outline-none focus:border-[#0A68F5]/40 focus:ring-1 focus:ring-[#0A68F5]/20 transition-all"
              />
            </div>
