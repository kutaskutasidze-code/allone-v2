  ...
  return (
    <section className="relative grid grid-cols-1 max-w-[1080px] mx-auto px-4 pt-8 sm:pt-16 pb-24 overflow-hidden border-b border-[#EBEBEB]">
      ...
      <div className="relative mt-10 sm:mt-16 h-[200px] sm:h-[300px] flex items-center justify-center">
        {/* Mobile: single static blur. Desktop: animated blobs */}
        <div className="sm:hidden absolute inset-0 flex items-center justify-center">
          <div className="w-[300px] h-[150px] bg-blue-400/30 rounded-full blur-[60px]" />
        </div>
        <div className="hidden sm:contents">
          <motion.div className="absolute w-[700px] h-[200px] rounded-[50%]" style={{ backgroundColor: 'rgb(96,165,250)', opacity: 0.45, filter: 'blur(90px)', WebkitFilter: 'blur(90px)', transform: 'translate3d(0,0,0)' }} animate={{ x: [-120, -60, -140, -80, -120], y: [0, -20, 15, -10, 0], scaleX: [1, 1.2, 0.95, 1.1, 1], opacity: [0.45, 0.35, 0.5, 0.4, 0.45] }} transition={{ duration: 14, repeat: Infinity, ease: 'easeInOut' }} />
          <motion.div className="absolute w-[600px] h-[180px] rounded-[50%]" style={{ backgroundColor: 'rgb(56,189,248)', opacity: 0.4, filter: 'blur(80px)', WebkitFilter: 'blur(80px)', transform: 'translate3d(0,0,0)' }} animate={{ x: [80, 30, 120, 60, 80], y: [-10, 20, -15, 10, -10], scaleX: [1.1, 0.9, 1.15, 1, 1.1], opacity: [0.4, 0.5, 0.35, 0.45, 0.4] }} transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }} />
          <motion.div className="absolute w-[650px] h-[170px] rounded-[50%]" style={{ backgroundColor: 'rgb(99,102,241)', opacity: 0.35, filter: 'blur(70px)', WebkitFilter: 'blur(70px)', transform: 'translate3d(0,0,0)' }} animate={{ x: [0, 70, -50, 30, 0], y: [30, 10, 40, 15, 30], scaleX: [1, 1.15, 1.05, 1.2, 1], opacity: [0.35, 0.25, 0.4, 0.3, 0.35] }} transition={{ duration: 16, repeat: Infinity, ease: 'easeInOut' }} />
          <motion.div className="absolute w-[550px] h-[160px] rounded-[50%]" style={{ backgroundColor: 'rgb(14,165,233)', opacity: 0.45, filter: 'blur(80px)', WebkitFilter: 'blur(80px)', transform: 'translate3d(0,0,0)' }} animate={{ x: [-30, 50, -60, 20, -30], y: [-25, -40, -15, -35, -25], scaleX: [1.05, 0.95, 1.1, 1, 1.05], opacity: [0.45, 0.5, 0.35, 0.4, 0.45] }} transition={{ duration: 18, repeat: Infinity, ease: 'easeInOut' }} />
          <motion.div className="absolute w-[180px] h-[100px] rounded-[50%] z-20" style={{ backgroundColor: 'rgb(59,130,246)', opacity: 0.3, filter: 'blur(50px)', WebkitFilter: 'blur(50px)', transform: 'translate3d(0,0,0)' }} animate={{ x: [160, -160, 150, -140, 160], y: [-100, 100, -90, 80, -100], backgroundColor: ['rgb(59,130,246)', 'rgb(56,189,248)', 'rgb(99,102,241)', 'rgb(59,130,246)'], opacity: [0.3, 0.4, 0.2, 0.35, 0.3] }} transition={{ duration: 12, repeat: Infinity, ease: 'easeInOut' }} />
        </div>
