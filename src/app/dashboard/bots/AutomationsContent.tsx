  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-xl font-medium text-zinc-900">Workflows</h1>
          <p className="text-sm text-zinc-500">{projects.length}/{limit} workflows</p>
        </div>
        {canCreate && (
      ...
      {projects.length > 0 ? (
          ...
          {projects.map((project, index) => (
            ...
            >
              <Link
                ...
                className="flex items-center gap-4 p-4 rounded-xl border border-zinc-200 bg-gradient-to-br from-white to-purple-50/30 hover:border-purple-200 hover:shadow-sm transition-all group"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    <span className="text-xs text-zinc-500">{project.usage_count || 0} runs</span>
                  </div>
                </div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="border border-zinc-200 rounded-xl p-12 text-center bg-gradient-to-br from-white to-purple-50/30"
        >
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center mx-auto mb-4">
            <Zap className="w-6 h-6 text-purple-500" />
          </div>
          <h3 className="font-medium text-zinc-900 mb-2">No workflows yet</h3>
