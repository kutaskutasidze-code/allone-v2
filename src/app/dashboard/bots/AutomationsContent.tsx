  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-[22px] font-semibold text-[#1d1d1f] tracking-tight">Workflows</h1>
          <p className="text-[13px] text-[#86868b] mt-0.5">{projects.length} of {limit} workflows</p>
        </div>
        {canCreate && (
          <Link
      ...
      {projects.length > 0 ? (
        ...
        >
          ...
          <h3 className="text-[15px] font-medium text-[#1d1d1f] mb-1">No workflows yet</h3>
          <p className="text-[13px] text-[#86868b] mb-5">Create workflows to automate tasks.</p>
          <Link
            href="/dashboard/studio"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-[#1d1d1f] text-white text-[13px] font-medium rounded-full hover:bg-[#3a3a3c] transition-colors"
          >
