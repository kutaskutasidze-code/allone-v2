...
interface RAGBotsContentProps {
  projects: Project[];
  limit: number;
}

export default function RAGBotsContent({ projects, limit }: RAGBotsContentProps) {
    ...
    <div>
      ...
      {projects.length > 0 ? (
          ...
          {projects.map((project, index) => (
            ...
            >
              <Link
                ...
                className="flex items-center gap-4 p-4 rounded-xl border border-zinc-200 bg-gradient-to-br from-white to-green-50/30 hover:border-green-200 hover:shadow-sm transition-all group"
              >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="border border-zinc-200 rounded-xl p-12 text-center bg-gradient-to-br from-white to-green-50/30"
        >
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center mx-auto mb-4">
