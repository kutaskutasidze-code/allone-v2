          ...
          {filteredCapabilities.map((cap, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-medium text-[var(--ink-900)] mb-1">{cap.name}</h3>
                <p className="text-xs text-[var(--ink-500)] line-clamp-2 mb-3">
                  {cap.description || 'No description'}
                </p>
                <div className="flex items-center justify-between text-xs">
                  <span className="px-2 py-0.5 bg-[var(--bg-sunken)] text-[var(--gray-600)] rounded">
                  ...
                  {cap.source && (
                    <a
                      ...
                      className="flex items-center gap-1 text-[var(--gray-400)] hover:text-[var(--ink-900)] transition-colors"
                    >
