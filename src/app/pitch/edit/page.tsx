...
const defaultContent = {
  en: {
    slides: [
      ...
      { id: 6, type: 'sales_strategy', title: 'How We Sell', statement: 'Simple, proven strategies for AI product sales', strategies: [{ name: 'Show Don\'t Tell', desc: 'Live demos with their actual use case' }, { name: 'Time-Savings ROI', desc: '$300/month = $2.30/hour to save 130+ hours monthly' }, { name: 'Before/After Proof', desc: 'Show concrete before/after metrics' }, { name: 'Competitor Pressure', desc: '63% of leaders worry about falling behind without AI' }, { name: 'Instant Payback', desc: '2 extra customers/month covers the subscription' }, { name: 'Risk-Free Start', desc: 'Build AI agent this week, refund if no results' }], framework: 'Demo → Show savings → Prove with competitors → Risk-free trial → Close with ROI math' },
      ...
      { id: 10, type: 'closing', title: 'Why This Works', statement: 'Business logic, not startup promises', reasons: [{ point: 'No fixed sales costs', detail: 'Salespeople earn only when they sell (25% commission)' }, { point: 'High margins', detail: '68.4% gross, 51.9% EBITDA' }, { point: 'Recurring revenue', detail: 'Clients pay monthly, average 15-month lifetime' }, { point: 'EBITDA positive Month 2', detail: 'Self-sustaining from month 2' }, { point: '$196K cash by Year 1', detail: 'From $40K initial investment' }, { point: 'Simple product', detail: '"AI answers my phone for $300/month"' }] },
  ...
  ka: {
    slides: [
      ...
      { id: 2, type: 'service', title: 'რას ვაკეთებთ', statement: 'ჩვენ ტექნოლოგიური სერვისების კომპანია ვართ', steps: [{ number: '01', name: 'კონსულტაცია', desc: 'ვაანალიზებთ, რა სჭირდება კლიენტს' }, { number: '02', name: 'დაგეგმვა', desc: 'ვპროექტებთ AI გადაწყვეტილებას' }, { number: '03', name: 'შესრულება', desc: 'ვაშენებთ ერთ კვირაში' }, { number: '04', name: 'მხარდაჭერა', desc: 'ვმართავთ ყოველთვიურად' }], analogy: 'როგორც საკონსულტაციო ფირმა + IT — თვეში $300-ად' },
      { id: 3, type: 'products', title: 'რას ვაშენებთ', statement: 'AI ინსტრუმენტები', items: [{ name: 'ხმოვანი აგენტები', desc: 'AI პასუხობს ტელეფონზე 24/7' }, { name: 'ჭკვიანი ჩატბოტები', desc: 'AI გაწვრთნილი ბიზნეს-დოკუმენტებზე' }, { name: 'ავტომატიზაციები', desc: 'AI ამუშავებს ელ-ფოსტას ავტომატურად' }, { name: 'ინდივიდუალური AI', desc: 'მორგებული სისტემები' }] },
      ...
      { id: 6, type: 'sales_strategy', title: 'როგორ ვყიდით', statement: 'მარტივი სტრატეგიები', strategies: [{ name: 'აჩვენე, ნუ ხსნი', desc: 'ცოცხალი დემო' }, { name: 'დროის ROI', desc: '$300/თვეში = $2.30/საათში' }, { name: 'წინა/შემდეგ', desc: 'კონკრეტული მეტრიკები' }, { name: 'კონკურენტის ზეწოლა', desc: '63% ლიდერი შეშფოთებულია' }, { name: 'მყისიერი ანაზღაურება', desc: '2 კლიენტი = ფარავს ხარჯს' }, { name: 'რისკის გარეშე', desc: 'პირველი თვე უკან ბრუნდება' }], framework: 'დემო → დაზოგვა → კონკურენტი → ცდა → ROI' },
      ...
      { id: 10, type: 'closing', title: 'რატომ მუშაობს', statement: 'ბიზნეს ლოგიკა', reasons: [{ point: 'ფიქს. ხარჯის გარეშე', detail: '25% საკომისიო' }, { point: 'მაღალი მარჟა', detail: '68.4% მთლიანი, 51.9% EBITDA' }, { point: 'განმეორებადი შემოსავალი', detail: '15 თვე საშუალოდ' }, { point: 'EBITDA+ მე-2 თვიდან', detail: '$196K წმინდა მოგება' }, { point: '$196K ნაღდი', detail: '$40K → $196K 12 თვეში' }, { point: 'მარტივი პროდუქტი', detail: 'AI $300/თვეში' }] },
