...
const slides = [
  { id: 1, type: 'title' },
  { id: 2, type: 'service', title: 'რას ვაკეთებთ', statement: 'ჩვენ ტექნოლოგიური სერვისების კომპანია ვართ', steps: [{ number: '01', name: 'კონსულტაცია', desc: 'ვაანალიზებთ, რა სჭირდება კლიენტს' }, { number: '02', name: 'დაგეგმვა', desc: 'ვპროექტებთ AI გადაწყვეტილებას' }, { number: '03', name: 'შესრულება', desc: 'ვაშენებთ და ვნერგავთ ერთ კვირაში' }, { number: '04', name: 'მხარდაჭერა', desc: 'ვმართავთ, ვაახლებთ — ყოველთვიურად' }], analogy: 'როგორც საკონსულტაციო ფირმა + IT დეპარტამენტი — პროექტზე $2,500-დან' },
  { id: 3, type: 'products', title: 'რას ვაშენებთ', items: [{ name: 'ვებ დეველოპმენტი', desc: 'თანამედროვე ვებსაიტები და აპლიკაციები' }, { name: 'ხმოვანი აგენტები', desc: 'AI პასუხობს ტელეფონზე, ჯავშნის შეხვედრებს — 24/7' }, { name: 'ჭკვიანი ჩატბოტები', desc: 'AI, გაწვრთნილი ბიზნეს-დოკუმენტებზე' }, { name: 'ავტომატიზაციები', desc: 'AI ამუშავებს ელ-ფოსტას, მონაცემებს ავტომატურად' }] },
  { id: 4, type: 'sales_strategy', title: 'როგორ ვყიდით', strategies: [{ name: 'აჩვენე, ნუ ხსნი', desc: 'ცოცხალი დემო კონკრეტული სცენარით' }, { name: 'დროის დაზოგვა', desc: 'ერთი პროექტი = 130+ საათის დაზოგვა თვეში' }, { name: 'წინა/შემდეგ', desc: '20 ლიდი იკარგებოდა → 90% დაფიქსირდა' }, { name: 'კონკურენტი', desc: '63% ლიდერი შეშფოთებულია AI-ს გარეშე' }, { name: 'მყისიერი ანაზღაურება', desc: '2 კლიენტი/თვეში ანაზღაურებს' }, { name: 'რისკის გარეშე', desc: '7 დღეში არ მუშაობს? თვე უკან' }] },
  { id: 5, type: 'operations', title: 'როგორ მუშაობს', flow: [{ step: 'გაყიდვები', detail: 'საკომისიო აგენტები (10%)' }, { step: 'ტექნიკური', detail: 'კონსულტაცია + აშენება (1 კვირა)' }, { step: 'AI პლატფორმა', detail: 'ავტომატურად, 24/7' }, { step: 'მხარდაჭერა', detail: 'ყოველთვიური მოვლა' }] },
  { id: 6, type: 'closing', title: 'რატომ მუშაობს', reasons: [{ point: '10% საკომისიო მხოლოდ', detail: 'ფიქსირებული გაყიდვების ხარჯის გარეშე' }, { point: '61%→87% მარჟა', detail: 'იზრდება მასშტაბთან ერთად' }, { point: 'პროექტზე დაფუძნებული', detail: '$2,500→$4,500 პროექტზე' }, { point: 'EBITDA+ მე-6 თვიდან', detail: 'ნაღდი ფული პოზიტიური' }, { point: '$40K → $187K ბალანსი', detail: '12 თვეში' }, { point: '2-წლიანი შემოსავალი', detail: '$903,000' }] },
  { id: 7, type: 'brand' },
];
