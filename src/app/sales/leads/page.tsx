...
import { Search, X, Users, MessageSquare, ExternalLink, Phone, Mail, Globe, Trash2, CalendarClock } from 'lucide-react';
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {l.callback_date && l.status === 'callback' && (
                      <CallbackBadge callbackDate={l.callback_date as string} />
                    )}
                    <LeadStatusDropdown
