...
function AddReferenceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <form
        onSubmit={submit}
        className="w-full max-w-md space-y-4 rounded-2xl border border-[var(--gray-200)] bg-white p-6 shadow-xl"
      >
        ...
        <label className="block">
          ...
          <select
            ...
            className="mt-1 w-full rounded-lg border border-[var(--gray-200)] bg-white px-3 py-2 text-sm focus:border-[#0ea5e9] focus:outline-none"
          >
            {SEGMENTS.map((s) => (
