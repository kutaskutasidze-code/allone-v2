...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'services.automation.label': 'Workflow Automation',
    'services.automation.h2a': 'Automate the work',
    'services.automation.h2b': 'that slows you down',
    'services.automation.desc': 'From lead scoring to invoice processing, we build custom workflows that run 24/7 — so your team focuses on what matters.',
  ...
  ka: {
    ...
    'services.automation.label': 'სამუშაო პროცესების ავტომატიზაცია',
    'services.automation.h2a': 'ავტომატიზირეთ სამუშაო',
    'services.automation.h2b': 'რომელიც განელებთ',
    'services.automation.desc': 'ლიდების შეფასებიდან ინვოისების დამუშავებამდე, ვაშენებთ სამუშაო პროცესებს რომლებიც 24/7 მუშაობს.',
