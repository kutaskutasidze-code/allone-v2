...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'services.chatbot.h2a': 'AI chatbots for every channel',
    'services.chatbot.channels': 'Channels',
    'services.chatbot.channels.h3a': 'Every platform,',
    'services.chatbot.channels.h3b': 'one AI brain',
    'services.chatbot.channels.desc': 'Deploy on WhatsApp, Instagram, Telegram, Messenger, and your website — one AI, everywhere your customers are.',
    'services.chatbot.preview': 'Live preview',
    'services.chatbot.integrations': 'Integrations',
    'services.chatbot.integrations.h3a': 'Connected to',
    'services.chatbot.integrations.h3b': 'your tools',
    'services.chatbot.integrations.desc': 'Book meetings, update CRMs, process payments, and trigger workflows — all from the conversation.',
    'services.chatbot.more': '+50 more',
    'services.webdev.label': 'Web Development',
    'services.webdev.h2a': 'Websites that convert',
    'services.webdev.h2b': 'visitors into customers',
    'services.webdev.desc': 'We design and build fast, modern web applications with Next.js — optimized for performance, SEO, and conversion from day one.',
    'services.consult.label': 'Not sure where to start?',
    'services.consult.h2': "Let's figure it out together",
    'services.consult.name': 'Name',
    'services.consult.email': 'Email',
    'services.consult.phone': 'Phone',
    'services.consult.looking': 'Looking for',
    'services.consult.message': 'Message',
    'services.consult.optional': '(optional)',
    'services.consult.chatbot': 'Chatbot',
    'services.consult.website': 'Website',
    'services.consult.automation': 'Automation',
    'services.consult.other': 'Other',
    'services.consult.submit': 'Book free consultation',
    'services.consult.footer': 'Free 30-min call · No commitment · Response within 24h',
  ...
  ka: {
    ...
    'landing.faq.q1.a': 'ALLONE არის AI ავტომატიზაციის სააგენტო თბილისსა (საქართველო) და ბრიუსელში (ბელგია) ოფისებით. ვქმნით სამ მთავარ პროდუქტს: AI ჩატბოტებს WhatsApp-ზე, Telegram-ზე, Instagram-სა და ვებზე; სამუშაო პროცესების ავტომატიზაციას, რომელიც აკავშირებს თქვენს CRM-ს, ინვოისინგსა და შიდა ხელსაწყოებს; და მაღალი წარმადობის ვებსაიტებს Next.js-ზე. AI-ზე დაფუძნებული მიდგომის წყალობით, ვაწვდით კვირებში და არა თვეებში.',
    ...
    'landing.faq.q6.a': 'Frontend: Next.js, React, TypeScript, Tailwind CSS. Backend: Node.js, Python, Supabase, PostgreSQL. AI: OpenAI-ისა და Anthropic-ის LLM-ების ინტეგრაცია, RAG სისტემები, მორგებული ML მოდელები. ავტომატიზაცია: n8n, Zapier და მორგებული სამუშაო ძრავები. Cloud: Vercel, AWS, Cloudflare.',
    'landing.faq.q7.q': 'რით განსხვავდება ALLONE სხვა სააგენტოებისგან?',
    'landing.faq.q7.a': 'AI-ს ვიყენებთ ჩვენს საკუთარ სამუშაო პროცესში — არა მხოლოდ იმაში, რასაც ვაწვდით. ეს ნიშნავს, რომ 3-კაციანი გუნდი ALLONE-ში აკეთებს იმას, რაც ტრადიციულ სააგენტოში 10-15 ადამიანს სჭირდება. შედეგი: უფრო სწრაფი მიწოდება, ნაკლები ხარჯი და გუნდი, რომელიც ღრმად იცნობს იმ AI ხელსაწყოებს, რომლებსაც თქვენთვის ვქმნით.',

    // Services sections
    'services.chatbot.label': 'AI ჩატბოტები',
    'services.chatbot.h2a': 'AI ჩატბოტები ყველა არხისთვის',
    'services.chatbot.channels': 'არხები',
    'services.chatbot.channels.h3a': 'ყველა პლატფორმა,',
    'services.chatbot.channels.h3b': 'ერთი AI ტვინი',
    'services.chatbot.channels.desc': 'განათავსეთ WhatsApp-ზე, Instagram-ზე, Telegram-ზე, Messenger-ზე და თქვენს ვებსაიტზე — ერთი AI, ყველგან სადაც თქვენი კლიენტები არიან.',
    'services.chatbot.preview': 'პირდაპირ ეთერში',
    'services.chatbot.integrations': 'ინტეგრაციები',
    'services.chatbot.integrations.h3a': 'დაკავშირებულია',
    'services.chatbot.integrations.h3b': 'თქვენს ინსტრუმენტებთან',
    'services.chatbot.integrations.desc': 'დაჯავშნეთ შეხვედრები, განაახლეთ CRM, დაამუშავეთ გადახდები და გაუშვით სამუშაო პროცესები — ყველაფერი საუბრიდან.',
    'services.chatbot.more': '+50 სხვა',
    'services.webdev.label': 'ვებ დეველოპმენტი',
    'services.webdev.h2a': 'ვებსაიტები რომლებიც',
    'services.webdev.h2b': 'ვიზიტორებს კლიენტებად აქცევს',
    'services.webdev.desc': 'ჩვენ ვაშენებთ სწრაფ, თანამედროვე ვებ აპლიკაციებს Next.js-ით — ოპტიმიზირებულს წარმადობის, SEO-ს და კონვერსიისთვის.',
    'services.consult.label': 'არ იცით საიდან დაიწყოთ?',
    'services.consult.h2': 'მოდით ერთად გავარკვიოთ',
    'services.consult.name': 'სახელი',
    'services.consult.email': 'ელ-ფოსტა',
    'services.consult.phone': 'ტელეფონი',
    'services.consult.looking': 'ეძებთ',
    'services.consult.message': 'შეტყობინება',
    'services.consult.optional': '(არასავალდებულო)',
    'services.consult.chatbot': 'ჩატბოტი',
    'services.consult.website': 'ვებსაიტი',
    'services.consult.automation': 'ავტომატიზაცია',
    'services.consult.other': 'სხვა',
    'services.consult.submit': 'დაჯავშნეთ უფასო კონსულტაცია',
    'services.consult.footer': 'უფასო 30-წუთიანი ზარი · ვალდებულების გარეშე · პასუხი 24 საათში',
