...
<section class="page">
  ...
  <div class="conditions">
    <ol>
      ...
      <li>წინამდებარე ინვოისი წარმოადგენს ხელშეკრულების შემადგენელ ნაწილს (დოკუმენტი N${esc(doc_number)}).</li>
  ...
  <div class="doc-footer">
    <span>ეს ინვოისი არის ნაწილი ${today}-ს მომზადებული მომსახურების ხელშეკრულებისა (დოკუმენტი N${esc(doc_number)}).</span>
